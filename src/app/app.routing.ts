...
export const appRoutes: Route[] = [
  ...
  // Auth routes for guests
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: () =>
          import(
            'app/modules/auth/anonymous-login/anonymous-login.module'
          ).then((m) => m.AnonymousLoginInModule),
      },
    ],
  },
  ...
  // Anonymous routes
  {
    ...
    children: [
      //{path: 'example', loadChildren: () => import('app/modules/admin/example/example.module').then(m => m.ExampleModule)},
      {
        path: 'company',
        loadChildren: () =>
          import('app/modules/admin/dashboards/company/company.module').then(
            (m) => m.CompanyModule
          ),
      },
    ],
  ...
  {
    path: 'dashboard/company/:company_name',
    loadChildren: () => import('app/modules/admin/dashboards/company/company.module').then(
      (m) => m.CompanyModule
    )
  },
  {
