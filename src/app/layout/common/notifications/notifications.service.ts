...
export class NotificationsService
{
    ...
    getAll(): Observable<Notification[]>
    {
        return this._httpClient.get<Notification[]>('api/common/notifications').pipe(
            tap((notifications) => {
                // this.translateNotifications(notifications);
    ...
    translateNotifications(notifications: Notification[]): void
    {
        notifications.forEach(notification=>notification.title = I18nModule.translate(notification.id));
    }
}
