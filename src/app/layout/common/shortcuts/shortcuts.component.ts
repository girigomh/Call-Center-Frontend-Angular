    ...
    ngOnInit(): void {
        ...
        this._shortcutsService.shortcuts$
            ...
            .subscribe((shortcuts: Shortcut[]) => {
                //translate the shortcut
                shortcuts.map((shortcut: any) => {
                  shortcut.description = I18nModule.translate(
                    'dashboard.shortcut.' +
                      shortcut.label.toLowerCase() +
                      '.description'
                  );
                  shortcut.label = I18nModule.translate(
                    'dashboard.shortcut.' + shortcut.label.toLowerCase()
                  );
                });
                // Load the shortcuts
